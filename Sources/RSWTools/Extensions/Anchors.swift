...
extension UIView {
    ...
    @discardableResult
    open func fillSafeSuperview(safeTop: Bool, safeBottom: Bool, safeLeading: Bool, safeTrialing: Bool, padding: UIEdgeInsets = .zero)  -> AnchoredConstraints{
        ...
        return anchor(top: topAnchor, bottom: bottomAnchor, leading: leadingAnchor, trailing: trailingAnchor, padding: padding)
    }
    
    @discardableResult
    open func anchor(top: NSLayoutYAxisAnchor?, bottom: NSLayoutYAxisAnchor?, leading: NSLayoutXAxisAnchor?, trailing: NSLayoutXAxisAnchor?, padding: UIEdgeInsets = .zero, size: CGSize = .zero) -> AnchoredConstraints {
